...
# installed.
TK_PREFIX='/home/iheb/PycharmProjects/AIE-v1/first-demo-adaptive-information-3-microservices/GatewayMicroService/env'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/home/iheb/PycharmProjects/AIE-v1/first-demo-adaptive-information-3-microservices/GatewayMicroService/env'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/home/iheb/PycharmProjects/AIE-v1/first-demo-adaptive-information-3-microservices/GatewayMicroService/env/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/home/iheb/PycharmProjects/AIE-v1/first-demo-adaptive-information-3-microservices/GatewayMicroService/env/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/home/iheb/PycharmProjects/AIE-v1/first-demo-adaptive-information-3-microservices/GatewayMicroService/env/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/opt/conda/conda-bld/tk_1654088763175/work/tk8.6.12/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/home/iheb/PycharmProjects/AIE-v1/first-demo-adaptive-information-3-microservices/GatewayMicroService/env/lib/libtkstub8.6.a'
